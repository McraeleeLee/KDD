...
def report_score( stdout, score,ndcg_50_full, ndcg_50_half,hitrate_50_full, hitrate_50_half):
     print(stdout, score,ndcg_50_full, ndcg_50_half,hitrate_50_full, hitrate_50_half)
...
evaluate(stdout=[],submit_fname = 'result/baseline_inject_time.csv',answer_fname='debias_track_answer.csv', current_time=None)
#print(a)